...
- We will rely on [:fontawesome-brands-python: **Python**](https://www.python.org/) within [:fontawesome-solid-laptop-code: **Visual Studio Code**](https://code.visualstudio.com/) (using an interactive Python script workflow), leveraging core data science libraries such as: [**pandas**](https://pandas.pydata.org/) for data management, [**Altair**](https://altair-viz.github.io/) for data visualization, and [**statsmodels**](https://www.statsmodels.org/) for statistical modeling.
- For reproducible academic writing and formatting, students will use [:fontawesome-solid-quote-left: **Typst**](https://typst.app/).
...
| - | :-: | - |
| :fontawesome-solid-award: **Milestones** | **50%** | 5 cumulative milestones (10% each) bridging research design, data wrangling, visualization, and modeling |
| :fontawesome-solid-chalkboard-user: **Participation** | **30%** | Student Group Live Demos (2 per group), peer discussion, and active engagement |
| :fontawesome-regular-file-code: **Research Paper** | **20%** | Original, reproducible scientific paper (~4,000–5,000 words in Typst) with complete analysis code |
...
Reserve private messages or emails with the instructor for personal matters, or if needed, [:fontawesome-regular-calendar-check: **book a 1-on-1 meeting**](https://cal.com/mickaeltemporao/1-1-meeting).
