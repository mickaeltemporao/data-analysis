...
- **Typst syntax**: Ensure proper citation format using `@citationkey` for all academic references
...
2. Scale Construction (when applicable)
...
4. Manuscript length must not exceed **3000 words** (excluding references, figures, and captions).
